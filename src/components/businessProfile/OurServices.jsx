        ...
        <div className="container-lg container-fluid md:px-20 lg:px-30 xl:px-30 py-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="animated bg-white rounded-md shadow p-6 text-center flex flex-col items-center justify-center">
              ...
              <h4 className="text-lg font-bold text-customGolden mb-2">
                CLOUD
              </h4>
              <p className="text-customGray">
                Safeguard your valuable data and applications stored on cloud
                platforms.
              </p>
            </div>
            ...
            <div className="animated bg-white rounded-md shadow p-6 text-center flex flex-col items-center justify-center">
              ...
              <p className="text-customGray">
                Embrace data with our Analytics and Robotic Process Automation
                solutions.
              </p>
            </div>
            <div className="animated bg-customGolden rounded-md shadow p-6 text-center flex flex-col items-center justify-center">
            ...
            <div className="animated bg-customGolden rounded-md shadow p-6 text-center flex flex-col items-center justify-center">
              ...
              <p className="text-customBlack">
                Bringing unparalleled efficiency to your manufacturing
                processes.
              </p>
            </div>
            <div className="animated bg-white rounded-md shadow p-6 text-center flex flex-col items-center justify-center">
            ...
            <div className="animated bg-customGolden rounded-md shadow p-6 text-center flex flex-col items-center justify-center">
              ...
              <p className="text-customBlack">
                Assisting various industries including mining, construction, and
                more.
              </p>
            </div>
            <div className="animated bg-white rounded-md shadow p-6 text-center flex flex-col items-center justify-center">
            ...
            <div className="animated bg-white rounded-md shadow p-6 text-center flex flex-col items-center justify-center">
              ...
              <p className="text-customGray">
                Comprehensive cyber security services for today's digital
                landscape.
              </p>
            </div>
            <div className="animated bg-customGolden rounded-md shadow p-6 text-center flex flex-col items-center justify-center">
              ...
              <p className="text-customBlack">
                Trusted personnel for asset, personnel, and high-profile client
                protection.
              </p>
            </div>
          </div>
