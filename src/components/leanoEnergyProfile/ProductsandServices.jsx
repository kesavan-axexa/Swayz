      ...
      <section className="py-12 bg-white sm:py-16 lg:py-20 overflow-hidden">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="max-w-full mx-auto text-center">
            ...
            >
Leano Energy has established relationships with major refineries within South Africa such as Sasol, Shell, BP, Engen, and Chevron. Our supplier relationships have provided us the capacity to provide large volumes of all products, allowing us to ensure that all our clients' needs are met at the best possible prices. Our price monitoring system enables us to source products at highly competitive prices, which in turn allows us to distribute them to our clients at comparatively low margins. We offer a wide range of petroleum products, refined with the best petroleum management solutions.            </motion.p>
          </div>
